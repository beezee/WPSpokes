...
class User extends \WPSpokes\Framework\Model
{
	...
	{
		return $this->hasMany('\WPSpokes\Framework\Models\UserMeta', 'user_id');
	}
	...
	public function roles()
	{
		return array(
            ...
            'meta_owner' => array('\WPSpokes\Framework\Roles\MetaOwner',
                                'relationship' => 'usermeta',
                                'meta_class_name' => '\WPSpokes\Framework\Models\UserMeta'),
        );
	}
}
